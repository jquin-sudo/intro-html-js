...
const newList = [
  ...
  { element: completedList, status: "done" },
];

const cssClasses = {
  pending:
    "bg-black w-full text-center text-purple-500 rounded py-4 border-2 border-purple-500 transition transform easein-out duration-300 hover:bg-purple-500 hover:text-white hover:scale-110 hover:rotate-1 cursor-pointer",
